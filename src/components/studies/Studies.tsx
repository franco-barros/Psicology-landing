...
const Studies: React.FC = () => (
  <section id="studies" className={styles.studiesSection}>
    ...
    <p className={styles.sectionSubtitle}>
      Formación continua en abordajes contextuales y terapias de tercera
      generación para brindar el mejor tratamiento basado en evidencia
    </p>

    <div className={styles.servicesContainer}>
      {studiesData.map((item: Study) => (
