  ...
  return (
    <section className={styles.digitalTherapySection} id="digital-therapy">
      ...
      <p className={styles.description}>
        Accede a terapia profesional desde la comodidad de tu hogar con la misma
        calidad y efectividad que las sesiones presenciales
      </p>

      <div className={styles.cardsGrid}>
        <div className={`${styles.card} ${styles.card1}`}>
          <h3 className={styles.cardTitle}>Ventajas de la Terapia Online</h3>
          {ventajas.map(({ title, description, icon: Icon, color }) => (
        ...
        <div className={`${styles.card} ${styles.card2}`}>
          ...
          {tecnologia.map(({ title, description, icon: Icon, color }) => (
            <div key={title} className={styles.cardItem}>
              <div className={styles.iconWithText}>
                <div className={styles.roundIcon}>
                  <Icon size={24} color={color} />
        ...
        <div className={`${styles.card} ${styles.card4}`}>
          <h3 className={styles.cardTitle}>Misma Efectividad Comprobada</h3>
